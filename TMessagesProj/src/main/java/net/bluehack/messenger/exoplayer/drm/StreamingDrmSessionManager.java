 ...
 */
package net.bluehack.messenger.exoplayer.drm;
...
import net.bluehack.messenger.exoplayer.drm.ExoMediaDrm.KeyRequest;
import net.bluehack.messenger.exoplayer.drm.ExoMediaDrm.OnEventListener;
import net.bluehack.messenger.exoplayer.drm.ExoMediaDrm.ProvisionRequest;
...
public class StreamingDrmSessionManager<T extends ExoMediaCrypto> implements DrmSessionManager<T> {
   ...
   *     obtained using {@link net.bluehack.messenger.exoplayer.ExoPlayer#getPlaybackLooper()}.
