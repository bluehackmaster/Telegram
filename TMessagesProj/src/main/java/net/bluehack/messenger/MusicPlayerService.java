...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "net.bluehack.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "net.bluehack.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "net.bluehack.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "net.bluehack.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "net.bluehack.android.musicplayer.next";
