 ...
 */
package net.bluehack.messenger.exoplayer.dash;

import android.os.Handler;
import android.util.Log;
import android.util.SparseArray;
import net.bluehack.messenger.exoplayer.BehindLiveWindowException;
import net.bluehack.messenger.exoplayer.C;
import net.bluehack.messenger.exoplayer.MediaFormat;
import net.bluehack.messenger.exoplayer.TimeRange;
import net.bluehack.messenger.exoplayer.TimeRange.DynamicTimeRange;
import net.bluehack.messenger.exoplayer.TimeRange.StaticTimeRange;
import net.bluehack.messenger.exoplayer.chunk.Chunk;
import net.bluehack.messenger.exoplayer.chunk.ChunkExtractorWrapper;
import net.bluehack.messenger.exoplayer.chunk.ChunkOperationHolder;
import net.bluehack.messenger.exoplayer.chunk.ChunkSource;
import net.bluehack.messenger.exoplayer.chunk.ContainerMediaChunk;
import net.bluehack.messenger.exoplayer.chunk.Format;
import net.bluehack.messenger.exoplayer.chunk.Format.DecreasingBandwidthComparator;
import net.bluehack.messenger.exoplayer.chunk.FormatEvaluator;
import net.bluehack.messenger.exoplayer.chunk.FormatEvaluator.Evaluation;
import net.bluehack.messenger.exoplayer.chunk.InitializationChunk;
import net.bluehack.messenger.exoplayer.chunk.MediaChunk;
import net.bluehack.messenger.exoplayer.chunk.SingleSampleMediaChunk;
import net.bluehack.messenger.exoplayer.dash.DashTrackSelector.Output;
import net.bluehack.messenger.exoplayer.dash.mpd.AdaptationSet;
import net.bluehack.messenger.exoplayer.dash.mpd.ContentProtection;
import net.bluehack.messenger.exoplayer.dash.mpd.MediaPresentationDescription;
import net.bluehack.messenger.exoplayer.dash.mpd.Period;
import net.bluehack.messenger.exoplayer.dash.mpd.RangedUri;
import net.bluehack.messenger.exoplayer.dash.mpd.Representation;
import net.bluehack.messenger.exoplayer.drm.DrmInitData;
import net.bluehack.messenger.exoplayer.extractor.ChunkIndex;
import net.bluehack.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor;
import net.bluehack.messenger.exoplayer.extractor.webm.WebmExtractor;
import net.bluehack.messenger.exoplayer.upstream.DataSource;
import net.bluehack.messenger.exoplayer.upstream.DataSpec;
import net.bluehack.messenger.exoplayer.util.Clock;
import net.bluehack.messenger.exoplayer.util.ManifestFetcher;
import net.bluehack.messenger.exoplayer.util.MimeTypes;
import net.bluehack.messenger.exoplayer.util.SystemClock;
