 ...
 */
package net.bluehack.messenger.exoplayer.text;
...
import net.bluehack.messenger.exoplayer.ExoPlaybackException;
...
import net.bluehack.messenger.exoplayer.SampleSourceTrackRenderer;
 ...
 *
 * <ul>
 * <li>WebVTT ({@link net.bluehack.messenger.exoplayer.text.webvtt.WebvttParser})</li>
 * <li>TTML
 * ({@link net.bluehack.messenger.exoplayer.text.ttml.TtmlParser})</li>
 * <li>SubRip
 * ({@link net.bluehack.messenger.exoplayer.text.subrip.SubripParser})</li>
 * <li>TX3G
 * ({@link net.bluehack.messenger.exoplayer.text.tx3g.Tx3gParser})</li>
 * </ul>
 *
  ...
  static {
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.text.webvtt.WebvttParser")
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.text.ttml.TtmlParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.text.webvtt.Mp4WebvttParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.text.subrip.SubripParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.text.tx3g.Tx3gParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
