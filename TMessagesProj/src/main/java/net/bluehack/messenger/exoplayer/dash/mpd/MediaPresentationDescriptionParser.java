 ...
 */
package net.bluehack.messenger.exoplayer.dash.mpd;
...
import net.bluehack.messenger.exoplayer.dash.mpd.SegmentBase.SegmentList;
import net.bluehack.messenger.exoplayer.dash.mpd.SegmentBase.SegmentTemplate;
import net.bluehack.messenger.exoplayer.dash.mpd.SegmentBase.SegmentTimelineElement;
import net.bluehack.messenger.exoplayer.dash.mpd.SegmentBase.SingleSegmentBase;
import net.bluehack.messenger.exoplayer.drm.DrmInitData.SchemeInitData;
import net.bluehack.messenger.exoplayer.extractor.mp4.PsshAtomUtil;
import net.bluehack.messenger.exoplayer.upstream.UriLoadable;
import net.bluehack.messenger.exoplayer.util.Assertions;
import net.bluehack.messenger.exoplayer.util.MimeTypes;
import net.bluehack.messenger.exoplayer.util.ParserUtil;
