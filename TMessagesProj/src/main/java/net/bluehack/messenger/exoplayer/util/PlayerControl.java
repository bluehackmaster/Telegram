...
public class PlayerControl implements MediaPlayerControl {
   ...
   * {@link net.bluehack.messenger.exoplayer.MediaCodecAudioTrackRenderer}, the recommended approach is
   * to extend the class and override
   * {@link net.bluehack.messenger.exoplayer.MediaCodecAudioTrackRenderer#onAudioSessionId}.
   *
