 ...
 */
package net.bluehack.messenger.exoplayer;
...
import net.bluehack.messenger.exoplayer.MediaCodecUtil.DecoderQueryException;
import net.bluehack.messenger.exoplayer.drm.DrmInitData;
import net.bluehack.messenger.exoplayer.drm.DrmSessionManager;
import net.bluehack.messenger.exoplayer.drm.FrameworkMediaCrypto;
import net.bluehack.messenger.exoplayer.util.Assertions;
import net.bluehack.messenger.exoplayer.util.NalUnitUtil;
import net.bluehack.messenger.exoplayer.util.TraceUtil;
...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "net.bluehack.messenger.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
