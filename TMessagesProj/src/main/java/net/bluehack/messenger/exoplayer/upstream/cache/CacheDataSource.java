 ...
 */
package net.bluehack.messenger.exoplayer.upstream.cache;

import android.net.Uri;
import android.util.Log;
import net.bluehack.messenger.exoplayer.C;
import net.bluehack.messenger.exoplayer.upstream.DataSink;
import net.bluehack.messenger.exoplayer.upstream.DataSource;
import net.bluehack.messenger.exoplayer.upstream.DataSpec;
import net.bluehack.messenger.exoplayer.upstream.FileDataSource;
import net.bluehack.messenger.exoplayer.upstream.TeeDataSource;
import net.bluehack.messenger.exoplayer.upstream.cache.CacheDataSink.CacheDataSinkException;
