 ...
 */
package net.bluehack.messenger.exoplayer.extractor;

import android.net.Uri;
import android.os.Handler;
import android.os.SystemClock;
import android.util.SparseArray;
import net.bluehack.messenger.exoplayer.C;
import net.bluehack.messenger.exoplayer.MediaFormat;
import net.bluehack.messenger.exoplayer.MediaFormatHolder;
import net.bluehack.messenger.exoplayer.ParserException;
import net.bluehack.messenger.exoplayer.SampleHolder;
import net.bluehack.messenger.exoplayer.SampleSource;
import net.bluehack.messenger.exoplayer.SampleSource.SampleSourceReader;
import net.bluehack.messenger.exoplayer.TrackRenderer;
import net.bluehack.messenger.exoplayer.drm.DrmInitData;
import net.bluehack.messenger.exoplayer.upstream.Allocator;
import net.bluehack.messenger.exoplayer.upstream.DataSource;
import net.bluehack.messenger.exoplayer.upstream.DataSpec;
import net.bluehack.messenger.exoplayer.upstream.Loader;
import net.bluehack.messenger.exoplayer.upstream.Loader.Loadable;
import net.bluehack.messenger.exoplayer.util.Assertions;
import net.bluehack.messenger.exoplayer.util.Util;
 ...
 *
 * <ul>
 * <li>MP4, including M4A ({@link net.bluehack.messenger.exoplayer.extractor.mp4.Mp4Extractor})</li>
 * <li>fMP4 ({@link net.bluehack.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor})</li>
 * <li>Matroska and WebM ({@link net.bluehack.messenger.exoplayer.extractor.webm.WebmExtractor})</li>
 * <li>Ogg Vorbis/FLAC ({@link net.bluehack.messenger.exoplayer.extractor.ogg.OggExtractor}</li>
 * <li>MP3 ({@link net.bluehack.messenger.exoplayer.extractor.mp3.Mp3Extractor})</li>
 * <li>AAC ({@link net.bluehack.messenger.exoplayer.extractor.ts.AdtsExtractor})</li>
 * <li>MPEG TS ({@link net.bluehack.messenger.exoplayer.extractor.ts.TsExtractor})</li>
 * <li>MPEG PS ({@link net.bluehack.messenger.exoplayer.extractor.ts.PsExtractor})</li>
 * <li>FLV ({@link net.bluehack.messenger.exoplayer.extractor.flv.FlvExtractor})</li>
 * <li>WAV ({@link net.bluehack.messenger.exoplayer.extractor.wav.WavExtractor})</li>
  ...
  static {
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.webm.WebmExtractor")
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.mp4.Mp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.mp3.Mp3Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.ts.AdtsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.ts.TsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.flv.FlvExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.ogg.OggExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.ts.PsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.extractor.wav.WavExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("net.bluehack.messenger.exoplayer.ext.flac.FlacExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
